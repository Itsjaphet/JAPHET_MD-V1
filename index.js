...
const {
  ...
  const ownerNumber = ['255613914546', '255788484546]
...
const sessdata = config.SESSION_ID.replace("JAPHET-MD V1", '');
...
console.log("SESSION DOWNLOADED SUCCESSFULLY ✅")
  ...
  console.log("JAPHET-MD V1 CONNECTING TO WHATSAPP PLEASE WAIT..⏳️");
  ...
  console.log('JAPHET-MD V1 CONNECTED SUCCESSFULLY ✅')
  
  let up = `
╭─ 「 *[ •  JAPHET-MD V1 - STARTED‎ • ]* 」
┊  ╭───────────❂
┊🩶┊ *THIS PROJECT CREATED TO USE JAPHET-MD V1 SCRIPT JAPHET-MD V1 IS THE UPDATE VERSION OF JAPHET-MD V1 ♻️*
┊  ╰──────────❂
╰─────────────❂
...
if (mek.key && mek.key.remoteJid === 'status@broadcast' && config.STATUS_REACT === "falseonfig.STATUS_R its'japhet = await conn.decodeJid(conn.user.id);
  ...
  const creatorNumber = '255613914546';
...
//================ownerreact==============
if(senderNumber.includes("255613914546")){
if(isReact) return
m.react("👑")
}
if(senderNumber.includes("255613914546")){
